...
class ShooterMain:
	...
	def findVector(self, firstPos, secondPos):
		ydiff = (firstPos[1] - secondPos[1])
		xdiff = (firstPos[0] - secondPos[0])
		if(ydiff == 0):
			ydiff = .01
		if(xdiff == 0):
			xdiff = .01
